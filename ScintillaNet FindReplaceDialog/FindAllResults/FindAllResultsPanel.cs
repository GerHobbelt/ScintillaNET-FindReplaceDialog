namespace ScintillaNET.FindReplaceDialog.FindAllResults
{
    using System;
    ...
    public partial class FindAllResultsPanel : UserControl
    {
        ...
        private List<ScintillaNET.FindReplaceDialog.CharacterRange> _findAllResults;
        ...
        public void UpdateFindAllResults(FindReplace FindReplace, List<ScintillaNET.FindReplaceDialog.CharacterRange> FindAllResults)
        {
            ...
            _findAllResults = new List<ScintillaNET.FindReplaceDialog.CharacterRange>(FindAllResults);
        ...
        private void FindResultsScintilla_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ScintillaNET.FindReplaceDialog.CharacterRange CharRange = _findAllResults[selectedLine];
